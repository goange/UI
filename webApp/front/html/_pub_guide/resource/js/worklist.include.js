...
function inc_IAHead(){
	...
	str+='<colgroup>';
	str+='	<col width="3%" /><!-- 번호 -->';
	str+='	<col class="depth2" style="width:12%" /><!-- 2Depth -->';
	str+='	<col class="depth3" style="width:12%" /><!-- 3Depth -->';
	str+='	<col class="depth4" style="width:8%" /><!-- 4Depth -->';
	str+='	<col class="depth5" style="width:12%" /><!-- Page -->';
	str+='	<col class="type" style="width:4%" /><!--Type -->';
	...
	str+='		<th scope="col" class="type">Type</th>';
